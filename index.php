...
<html lang="en">
  ...
  <head>
    ...
    <title>Omar Constante Construction</title>
<!--
Elegance Template
            ...
            <div class="section animated-row" data-section="slide01">
                <div class="section-inner">
                    <div class="welcome-box">
                        <span class="welcome-first animate" data-animate="fadeInUp">It is</span>
                        <h1 class="welcome-title animate" data-animate="fadeInUp">OMAR CONSTANTE CONSTRUCTION</h1>
                        <p class="animate" data-animate="fadeInUp">Welcome, I will make your dream house a reality!</p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="about-contentbox">
                                            <div class="animate" data-animate="fadeInUp">
                                                <span>About Me</span>
                                                <h2>Who am i?</h2>
                                                <p>I am a construction remodeling worker. My work varies from client to client but the visual of the homes come with upscale and high quality work.</p>
                                            </div>
                                            <!--<div class="facts-list owl-carousel">
                                                <div class="item animate" data-animate="fadeInUp">
                                                    <div class="counter-box">
                                                        <i class="fa fa-trophy counter-icon" aria-hidden="true"></i><span class="count-number">32</span> 
                                                    </div>
                                                </div>
                                                <div class="item animate" data-animate="fadeInUp">
                                                    <div class="counter-box">
                            ...
                            <div class="services-section">
                                <div class="services-list owl-carousel">
                                    ...
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="service-box">
                                            <span class="service-icon"><i class="fa fa-bookmark" aria-hidden="true"></i></span>
                                            <h3>Decks and Stairs</h3>
                                        </div>
                                    </div>
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="service-box">
                                            <span class="service-icon"><i class="fa fa-bookmark" aria-hidden="true"></i></span>
                                            <h3>Wall Fixes and Remodeling</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="portfolio-item">
                                            ...
                                            <div class="thumb-inner animate" data-animate="fadeInUp">
                                                <a href="tel:510-000-0000">
                                                    <h4>Click to call now!</h4>
                                                    <p>Please tell your friends about it.</p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 animate" data-animate="fadeInUp">
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-row">
                                                <i class="fa fa-phone"></i> 510-000-000
                                            </div>
                                            <div class="contact-row">
                                                <i class="fa fa-envelope"></i> luis@constante.com
                                            </div>
                                        </div>
                                    </div>
